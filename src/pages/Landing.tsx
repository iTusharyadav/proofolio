...
//     .scroll-container::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.06); border-radius: 8px; }

//     /* SCROLL SNAP FIX: proximity is smoother */
//     .scroll-container { 
...
//   return (
//     <div className={`${isDark ? "bg-gradient-to-br from-gray-900 via-gray-800 to-black text-gray-100" : "bg-gradient-to-br from-white via-gray-50 to-gray-100 text-gray-900"} min-h-[calc(100vh-120px)]
// `}>
...
//         <nav
//           /* Performance fix applied in previous step */
//           className={`nav-outline pointer-events-auto ${isDark ? "bg-neutral-900/80" : "bg-white/95"} rounded-3xl px-8 py-3 flex items-center justify-between w-[86%] max-w-6xl`}
//           role="navigation"
...
//             <li><a href="#features" className={`${isDark ? "text-gray-200 hover:text-teal-300" : "text-gray-700 hover:text-teal-600"} transition`}>Features</a></li>
//             <li><a href="#how" className={`${isDark ? "text-gray-200 hover:text-teal-300" : "text-gray-700 hover:text-teal-600"} transition`}>How it works</a></li>
//             <li><a href="#why" className={`${isDark ? "text-gray-200 hover:text-teal-300" : "text-gray-700 hover:text-teal-600"} transition`}>Why Us</a></li>
//             <li><a href="#faq" className={`${isDark ? "text-gray-200 hover:text-teal-300" : "text-gray-700 hover:text-teal-600"} transition`}>FAQ</a></li>
//           </ul>
...
//       <div
//         ref={scrollRef}
//         // Using 'h-screen' ensures the container occupies the full viewport height, crucial for scroll-snap.
//         className="scroll-container pt-[120px] h-screen overflow-y-auto"
//         role="main"
//       >
//         {/* HERO */}
//         <section className="section-snap snap-start min-h-[calc(100vh-120px)] flex items-center" aria-label="Hero">
...
//                 {/* feature bullets (bigger, fills space) */}
...
//                 <div className="absolute -left-6 -top-8 w-44 p-3 rounded-xl glass shadow-lg">
//                   <div className="flex items-center gap-3">
...
//                 <div className="absolute -right-4 bottom-6 w-44 p-3 rounded-xl glass shadow-lg">
//                   <div className="flex items-center gap-3">
//                     <div>
...
//         {/* 1. FIX: FEATURES - Layout changed to 2x2 for better balance */}
//         <section id="features" className="section-snap snap-start min-h-[calc(100vh-120px)] flex items-center fade-in" aria-label="Features">
//           <div className="max-w-7xl mx-auto px-6 w-full py-12">
//             <div className="flex items-center justify-between mb-8">
//               <h2 className="text-3xl md:text-4xl font-semibold">What DevScore analyzes</h2>
//               <button onClick={() => setShowDocPopup(true)} className={`${isDark ? "glass" : "bg-white border border-gray-200"} px-3 py-2 rounded-lg hover:scale-105 transition`}>Documentation</button>
//             </div>

//             {/* FIX APPLIED: Changed to lg:grid-cols-2 */}
...
//         {/* HOW */}
//         <section id="how" className="section-snap snap-start min-h-[calc(100vh-120px)] flex items-center" aria-label="How it works">
//           <div className="max-w-7xl mx-auto px-6 w-full py-12">
...
//         {/* 2. ENHANCEMENT: WHY US - Redesigned to be more beautiful and cool */}
//         <section id="why" className="section-snap snap-start min-h-[calc(100vh-120px)] flex items-center py-12" aria-label="Why choose us">
//           <div className="max-w-7xl mx-auto px-6 w-full">
//             <h2 className="text-3xl md:text-4xl font-semibold mb-12 text-center fade-in">The DevScore Advantage</h2>
...
//         {/* Testimonials - separated for better structure */}
//         <section id="testimonials" className="section-snap snap-start min-h-[calc(100vh-120px)] flex items-center py-12 fade-in" aria-label="Testimonials">
//           <div className="max-w-7xl mx-auto px-6 w-full">
//             <h2 className="text-3xl md:text-4xl font-semibold mb-12 text-center">Trusted by developers worldwide</h2>
//             <div className="grid md:grid-cols-3 gap-6">
//               {[
//                 { name: "Aisha Khan", role: "Frontend Dev, Toronto", text: "DevScore pointed out an underrated repo I had — I improved my profile and landed interviews immediately. Highly recommended!" },
//                 { name: "Rahul Verma", role: "Backend Engineer, Bangalore", text: "The GitHub insights are surprisingly deep. The server-side scoring logic gives me confidence in the security and accuracy of the results." },
//                 { name: "Leila Martinez", role: "Fullstack Developer, Berlin", text: "Easy signup and great action items. Loved the privacy-first approach and the clear roadmap for improvement." },
//               ].map((tItem, i) => (
//                 <blockquote key={i} className={`card-glow-hover ${isDark ? "glass border border-white/5" : "bg-white border border-gray-100"} p-6 rounded-xl shadow-lg transform hover:-translate-y-1 transition`}>
//                   <div className="flex text-yellow-500 mb-3">{[...Array(5)].map((_, j) => <Star key={j} className="w-4 h-4 fill-current" />)}</div>
//                   <div className={`${isDark ? "text-gray-200" : "text-gray-700"} italic`}>“{tItem.text}”</div>
//                   <div className="mt-4 text-sm font-bold">{tItem.name}</div>
//                   <div className={`${t.muted} text-xs`}>{tItem.role}</div>
//                 </blockquote>
//               ))}
//             </div>
//           </div>
...
//         {/* 3. FIX: FAQ SECTION - Redesigned to be professional and single-column on small screens */}
//         <section id="faq" className="section-snap snap-start min-h-[calc(100vh-120px)] flex items-center py-12 fade-in" aria-label="FAQ">
//           <div className="max-w-7xl mx-auto px-6 w-full">
...
//         {/* 4. FIX: CTA & FOOTER - Merged into one polished section */}
//         <footer id="docs" className="section-snap snap-start min-h-[calc(100vh-120px)] flex flex-col justify-end py-12" aria-label="Call to action and footer">
//           <div className="max-w-7xl mx-auto px-6 w-full">
//             {/* CTA Box */}
...
//                   <a className={`${t.muted} text-sm hover:text-teal-300 transition`} href="#" onClick={() => setShowDocPopup(true)}>Docs</a>
//                 </div>
//               </div>
